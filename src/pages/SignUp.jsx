                    ...
                    <form className="mt-4 space-y-4 text-sm w-full">
                        <div>
                            ...
                            <input
                                ...
                                className="block w-full p-3 rounded-2xl border border-border bg-surface mt-4 focus:outline-none focus:ring focus:ring-text-secondary transition duration-300"
                                required
                            />
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <div className="w-full flex items-center gap-5 px-3 mt-4 rounded-2xl border-2 border-border bg-surface focus-within:border-text-secondary/50 transition duration-300">
                                <input
                                    id="password"
